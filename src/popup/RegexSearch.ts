...
colorButton.addEventListener("click", (e) => {
  if (highlightColor && highlightColor[0] == "#") {
    ...
    document.querySelector<HTMLInputElement>("input[name='color'][value='" + highlightColor + "']").checked = true;
  }
  if (highlightBorderColor && highlightBorderColor[0] == "#") {
    ...
    document.querySelector<HTMLInputElement>("input[name='borderColor'][value='" + highlightBorderColor + "'").checked = true;
  }
});

// Update Color Button Event
updateColorButton.addEventListener("click", (e) => {
  highlightColor = document.querySelector<HTMLInputElement>("input[name='color']:checked").value;
  if(highlightColor === "custom")
    highlightColor = "#" + asInput(customColorInput)?.value;
  highlightBorderColor = document.querySelector<HTMLInputElement>("input[name='borderColor']:checked").value;
...
const isAnchor = (element: EventTarget): element is HTMLAnchorElement => element instanceof HTMLAnchorElement;

const asAnchor = (element: EventTarget) => isAnchor(element) ? element : undefined;

const isInput = (element: HTMLElement): element is HTMLInputElement => element instanceof HTMLInputElement;

const asInput = (element: HTMLElement) => isInput(element) ? element : undefined;

const isTextArea = (element: HTMLElement): element is HTMLTextAreaElement => element instanceof HTMLTextAreaElement;

const asTextArea = (element: HTMLElement) => isTextArea(element) ? element : undefined;
